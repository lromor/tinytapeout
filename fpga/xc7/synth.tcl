...
exec $::env(PYTHON3) $::env(UTILS_DIR)/fix_xc7_carry.py < $::env(OUT_JSON).carry_fixup.json > $::env(OUT_JSON).carry_fixup_out.json
design -push
...
design -reset
exec $::env(PYTHON3) $::env(UTILS_DIR)/split_inouts.py -i $::env(OUT_JSON) -o $::env(SYNTH_JSON)
