...
################################################################################
## Full Arty A7-35 pin catalog (from Digilent's Arty-A7-35-Master.xdc,
## converted to per-line set_property for the yosys xdc plugin).
## To use a resource: uncomment its lines AND rename the port to match your
## top-level Verilog. Ports referenced in active constraints must exist in
## the design, or synthesis fails.
################################################################################
...
## Switches
#set_property PACKAGE_PIN A8 [get_ports {sw[0]}]  # IO_L12N_T1_MRCC_16 Sch=sw[0]
#set_property IOSTANDARD LVCMOS33 [get_ports {sw[0]}]
#set_property PACKAGE_PIN C11 [get_ports {sw[1]}]  # IO_L13P_T2_MRCC_16 Sch=sw[1]
#set_property IOSTANDARD LVCMOS33 [get_ports {sw[1]}]
#set_property PACKAGE_PIN C10 [get_ports {sw[2]}]  # IO_L13N_T2_MRCC_16 Sch=sw[2]
#set_property IOSTANDARD LVCMOS33 [get_ports {sw[2]}]
#set_property PACKAGE_PIN A10 [get_ports {sw[3]}]  # IO_L14P_T2_SRCC_16 Sch=sw[3]
...
#set_property IOSTANDARD LVCMOS33 [get_ports {led3_g}]
#set_property PACKAGE_PIN K1 [get_ports {led3_r}]  # IO_L23N_T3_35 Sch=led3_r
#set_property IOSTANDARD LVCMOS33 [get_ports {led3_r}]

## LEDs
#set_property PACKAGE_PIN H5 [get_ports {led[0]}]  # IO_L24N_T3_35 Sch=led[4]
#set_property IOSTANDARD LVCMOS33 [get_ports {led[0]}]
#set_property PACKAGE_PIN J5 [get_ports {led[1]}]  # IO_25_35 Sch=led[5]
#set_property IOSTANDARD LVCMOS33 [get_ports {led[1]}]
#set_property PACKAGE_PIN T9 [get_ports {led[2]}]  # IO_L24P_T3_A01_D17_14 Sch=led[6]
#set_property IOSTANDARD LVCMOS33 [get_ports {led[2]}]
#set_property PACKAGE_PIN T10 [get_ports {led[3]}]  # IO_L24N_T3_A00_D16_14 Sch=led[7]
#set_property IOSTANDARD LVCMOS33 [get_ports {led[3]}]

## Buttons
#set_property PACKAGE_PIN D9 [get_ports {btn[0]}]  # IO_L6N_T0_VREF_16 Sch=btn[0]
#set_property IOSTANDARD LVCMOS33 [get_ports {btn[0]}]
#set_property PACKAGE_PIN C9 [get_ports {btn[1]}]  # IO_L11P_T1_SRCC_16 Sch=btn[1]
#set_property IOSTANDARD LVCMOS33 [get_ports {btn[1]}]
#set_property PACKAGE_PIN B9 [get_ports {btn[2]}]  # IO_L11N_T1_SRCC_16 Sch=btn[2]
#set_property IOSTANDARD LVCMOS33 [get_ports {btn[2]}]
#set_property PACKAGE_PIN B8 [get_ports {btn[3]}]  # IO_L12P_T1_MRCC_16 Sch=btn[3]
#set_property IOSTANDARD LVCMOS33 [get_ports {btn[3]}]

## Pmod Header JA
#set_property PACKAGE_PIN G13 [get_ports {ja[0]}]  # IO_0_15 Sch=ja[1]
#set_property IOSTANDARD LVCMOS33 [get_ports {ja[0]}]
#set_property PACKAGE_PIN B11 [get_ports {ja[1]}]  # IO_L4P_T0_15 Sch=ja[2]
#set_property IOSTANDARD LVCMOS33 [get_ports {ja[1]}]
#set_property PACKAGE_PIN A11 [get_ports {ja[2]}]  # IO_L4N_T0_15 Sch=ja[3]
#set_property IOSTANDARD LVCMOS33 [get_ports {ja[2]}]
#set_property PACKAGE_PIN D12 [get_ports {ja[3]}]  # IO_L6P_T0_15 Sch=ja[4]
#set_property IOSTANDARD LVCMOS33 [get_ports {ja[3]}]
#set_property PACKAGE_PIN D13 [get_ports {ja[4]}]  # IO_L6N_T0_VREF_15 Sch=ja[7]
#set_property IOSTANDARD LVCMOS33 [get_ports {ja[4]}]
#set_property PACKAGE_PIN B18 [get_ports {ja[5]}]  # IO_L10P_T1_AD11P_15 Sch=ja[8]
#set_property IOSTANDARD LVCMOS33 [get_ports {ja[5]}]
#set_property PACKAGE_PIN A18 [get_ports {ja[6]}]  # IO_L10N_T1_AD11N_15 Sch=ja[9]
#set_property IOSTANDARD LVCMOS33 [get_ports {ja[6]}]
#set_property PACKAGE_PIN K16 [get_ports {ja[7]}]  # IO_25_15 Sch=ja[10]
#set_property IOSTANDARD LVCMOS33 [get_ports {ja[7]}]

## Pmod Header JB
#set_property PACKAGE_PIN E15 [get_ports {jb[0]}]  # IO_L11P_T1_SRCC_15 Sch=jb_p[1]
#set_property IOSTANDARD LVCMOS33 [get_ports {jb[0]}]
#set_property PACKAGE_PIN E16 [get_ports {jb[1]}]  # IO_L11N_T1_SRCC_15 Sch=jb_n[1]
#set_property IOSTANDARD LVCMOS33 [get_ports {jb[1]}]
#set_property PACKAGE_PIN D15 [get_ports {jb[2]}]  # IO_L12P_T1_MRCC_15 Sch=jb_p[2]
#set_property IOSTANDARD LVCMOS33 [get_ports {jb[2]}]
#set_property PACKAGE_PIN C15 [get_ports {jb[3]}]  # IO_L12N_T1_MRCC_15 Sch=jb_n[2]
#set_property IOSTANDARD LVCMOS33 [get_ports {jb[3]}]
#set_property PACKAGE_PIN J17 [get_ports {jb[4]}]  # IO_L23P_T3_FOE_B_15 Sch=jb_p[3]
#set_property IOSTANDARD LVCMOS33 [get_ports {jb[4]}]
#set_property PACKAGE_PIN J18 [get_ports {jb[5]}]  # IO_L23N_T3_FWE_B_15 Sch=jb_n[3]
#set_property IOSTANDARD LVCMOS33 [get_ports {jb[5]}]
#set_property PACKAGE_PIN K15 [get_ports {jb[6]}]  # IO_L24P_T3_RS1_15 Sch=jb_p[4]
#set_property IOSTANDARD LVCMOS33 [get_ports {jb[6]}]
#set_property PACKAGE_PIN J15 [get_ports {jb[7]}]  # IO_L24N_T3_RS0_15 Sch=jb_n[4]
#set_property IOSTANDARD LVCMOS33 [get_ports {jb[7]}]

## Pmod Header JC
#set_property PACKAGE_PIN U12 [get_ports {jc[0]}]  # IO_L20P_T3_A08_D24_14 Sch=jc_p[1]
#set_property IOSTANDARD LVCMOS33 [get_ports {jc[0]}]
#set_property PACKAGE_PIN V12 [get_ports {jc[1]}]  # IO_L20N_T3_A07_D23_14 Sch=jc_n[1]
#set_property IOSTANDARD LVCMOS33 [get_ports {jc[1]}]
#set_property PACKAGE_PIN V10 [get_ports {jc[2]}]  # IO_L21P_T3_DQS_14 Sch=jc_p[2]
#set_property IOSTANDARD LVCMOS33 [get_ports {jc[2]}]
#set_property PACKAGE_PIN V11 [get_ports {jc[3]}]  # IO_L21N_T3_DQS_A06_D22_14 Sch=jc_n[2]
#set_property IOSTANDARD LVCMOS33 [get_ports {jc[3]}]
#set_property PACKAGE_PIN U14 [get_ports {jc[4]}]  # IO_L22P_T3_A05_D21_14 Sch=jc_p[3]
#set_property IOSTANDARD LVCMOS33 [get_ports {jc[4]}]
#set_property PACKAGE_PIN V14 [get_ports {jc[5]}]  # IO_L22N_T3_A04_D20_14 Sch=jc_n[3]
#set_property IOSTANDARD LVCMOS33 [get_ports {jc[5]}]
#set_property PACKAGE_PIN T13 [get_ports {jc[6]}]  # IO_L23P_T3_A03_D19_14 Sch=jc_p[4]
#set_property IOSTANDARD LVCMOS33 [get_ports {jc[6]}]
#set_property PACKAGE_PIN U13 [get_ports {jc[7]}]  # IO_L23N_T3_A02_D18_14 Sch=jc_n[4]
#set_property IOSTANDARD LVCMOS33 [get_ports {jc[7]}]

## Pmod Header JD
#set_property PACKAGE_PIN D4 [get_ports {jd[0]}]  # IO_L11N_T1_SRCC_35 Sch=jd[1]
#set_property IOSTANDARD LVCMOS33 [get_ports {jd[0]}]
#set_property PACKAGE_PIN D3 [get_ports {jd[1]}]  # IO_L12N_T1_MRCC_35 Sch=jd[2]
#set_property IOSTANDARD LVCMOS33 [get_ports {jd[1]}]
#set_property PACKAGE_PIN F4 [get_ports {jd[2]}]  # IO_L13P_T2_MRCC_35 Sch=jd[3]
#set_property IOSTANDARD LVCMOS33 [get_ports {jd[2]}]
#set_property PACKAGE_PIN F3 [get_ports {jd[3]}]  # IO_L13N_T2_MRCC_35 Sch=jd[4]
#set_property IOSTANDARD LVCMOS33 [get_ports {jd[3]}]
#set_property PACKAGE_PIN E2 [get_ports {jd[4]}]  # IO_L14P_T2_SRCC_35 Sch=jd[7]
#set_property IOSTANDARD LVCMOS33 [get_ports {jd[4]}]
#set_property PACKAGE_PIN D2 [get_ports {jd[5]}]  # IO_L14N_T2_SRCC_35 Sch=jd[8]
#set_property IOSTANDARD LVCMOS33 [get_ports {jd[5]}]
#set_property PACKAGE_PIN H2 [get_ports {jd[6]}]  # IO_L15P_T2_DQS_35 Sch=jd[9]
#set_property IOSTANDARD LVCMOS33 [get_ports {jd[6]}]
#set_property PACKAGE_PIN G2 [get_ports {jd[7]}]  # IO_L15N_T2_DQS_35 Sch=jd[10]
...
#set_property PACKAGE_PIN B2 [get_ports {vaux15_n}]  # IO_L10N_T1_AD15N_35 	Sch=ck_an_n[4]	ChipKit pin=A4
#set_property IOSTANDARD LVCMOS33 [get_ports {vaux15_n}]
#set_property PACKAGE_PIN B3 [get_ports {vaux15_p}]  # IO_L10P_T1_AD15P_35 	Sch=ck_an_p[4]	ChipKit pin=A4
#set_property IOSTANDARD LVCMOS33 [get_ports {vaux15_p}]
...
#set_property PACKAGE_PIN F5 [get_ports {ck_a0}]  # IO_0_35           	Sch=ck_a[0]		ChipKit pin=A0
#set_property IOSTANDARD LVCMOS33 [get_ports {ck_a0}]
#set_property PACKAGE_PIN D8 [get_ports {ck_a1}]  # IO_L4P_T0_35      	Sch=ck_a[1]		ChipKit pin=A1
#set_property IOSTANDARD LVCMOS33 [get_ports {ck_a1}]
#set_property PACKAGE_PIN C7 [get_ports {ck_a2}]  # IO_L4N_T0_35      	Sch=ck_a[2]		ChipKit pin=A2
#set_property IOSTANDARD LVCMOS33 [get_ports {ck_a2}]
#set_property PACKAGE_PIN E7 [get_ports {ck_a3}]  # IO_L6P_T0_35      	Sch=ck_a[3]		ChipKit pin=A3
#set_property IOSTANDARD LVCMOS33 [get_ports {ck_a3}]
#set_property PACKAGE_PIN D7 [get_ports {ck_a4}]  # IO_L6N_T0_VREF_35 	Sch=ck_a[4]		ChipKit pin=A4
#set_property IOSTANDARD LVCMOS33 [get_ports {ck_a4}]
#set_property PACKAGE_PIN D5 [get_ports {ck_a5}]  # IO_L11P_T1_SRCC_35	Sch=ck_a[5]		ChipKit pin=A5
#set_property IOSTANDARD LVCMOS33 [get_ports {ck_a5}]

## ChipKit Inner Analog Header - as Differential Analog Inputs
## NOTE: These ports can be used as differential analog inputs with voltages from 0-1.0V (ChipKit Analog pins A6-A11) or as digital I/O.
## WARNING: Do not use both sets of constraints at the same time!
## NOTE: The following constraints should be used with the XADC core when using these ports as analog inputs.
#set_property PACKAGE_PIN B7 [get_ports {vaux12_p}]  # IO_L2P_T0_AD12P_35	Sch=ad_p[12]	ChipKit pin=A6
#set_property IOSTANDARD LVCMOS33 [get_ports {vaux12_p}]
#set_property PACKAGE_PIN B6 [get_ports {vaux12_n}]  # IO_L2N_T0_AD12N_35	Sch=ad_n[12]	ChipKit pin=A7
#set_property IOSTANDARD LVCMOS33 [get_ports {vaux12_n}]
#set_property PACKAGE_PIN E6 [get_ports {vaux13_p}]  # IO_L5P_T0_AD13P_35	Sch=ad_p[13]	ChipKit pin=A8
#set_property IOSTANDARD LVCMOS33 [get_ports {vaux13_p}]
#set_property PACKAGE_PIN E5 [get_ports {vaux13_n}]  # IO_L5N_T0_AD13N_35	Sch=ad_n[13]	ChipKit pin=A9
#set_property IOSTANDARD LVCMOS33 [get_ports {vaux13_n}]
#set_property PACKAGE_PIN A4 [get_ports {vaux14_p}]  # IO_L8P_T1_AD14P_35	Sch=ad_p[14]	ChipKit pin=A10
#set_property IOSTANDARD LVCMOS33 [get_ports {vaux14_p}]
#set_property PACKAGE_PIN A3 [get_ports {vaux14_n}]  # IO_L8N_T1_AD14N_35	Sch=ad_n[14]	ChipKit pin=A11
#set_property IOSTANDARD LVCMOS33 [get_ports {vaux14_n}]
## ChipKit Inner Analog Header - as Digital I/O
## NOTE: the following constraints should be used when using the inner analog header ports as digital I/O.
#set_property PACKAGE_PIN B7 [get_ports {ck_a6}]  # IO_L2P_T0_AD12P_35	Sch=ad_p[12]	ChipKit pin=A6
#set_property IOSTANDARD LVCMOS33 [get_ports {ck_a6}]
#set_property PACKAGE_PIN B6 [get_ports {ck_a7}]  # IO_L2N_T0_AD12N_35	Sch=ad_n[12]	ChipKit pin=A7
#set_property IOSTANDARD LVCMOS33 [get_ports {ck_a7}]
#set_property PACKAGE_PIN E6 [get_ports {ck_a8}]  # IO_L5P_T0_AD13P_35	Sch=ad_p[13]	ChipKit pin=A8
#set_property IOSTANDARD LVCMOS33 [get_ports {ck_a8}]
#set_property PACKAGE_PIN E5 [get_ports {ck_a9}]  # IO_L5N_T0_AD13N_35	Sch=ad_n[13]	ChipKit pin=A9
#set_property IOSTANDARD LVCMOS33 [get_ports {ck_a9}]
#set_property PACKAGE_PIN A4 [get_ports {ck_a10}]  # IO_L8P_T1_AD14P_35	Sch=ad_p[14]	ChipKit pin=A10
#set_property IOSTANDARD LVCMOS33 [get_ports {ck_a10}]
#set_property PACKAGE_PIN A3 [get_ports {ck_a11}]  # IO_L8N_T1_AD14N_35	Sch=ad_n[14]	ChipKit pin=A11
#set_property IOSTANDARD LVCMOS33 [get_ports {ck_a11}]
...
#set_property PACKAGE_PIN D18 [get_ports {eth_rxd[0]}]  # IO_L21N_T3_DQS_A18_15 Sch=eth_rxd[0]
#set_property IOSTANDARD LVCMOS33 [get_ports {eth_rxd[0]}]
#set_property PACKAGE_PIN E17 [get_ports {eth_rxd[1]}]  # IO_L16P_T2_A28_15 Sch=eth_rxd[1]
#set_property IOSTANDARD LVCMOS33 [get_ports {eth_rxd[1]}]
#set_property PACKAGE_PIN E18 [get_ports {eth_rxd[2]}]  # IO_L21P_T3_DQS_15 Sch=eth_rxd[2]
#set_property IOSTANDARD LVCMOS33 [get_ports {eth_rxd[2]}]
#set_property PACKAGE_PIN G17 [get_ports {eth_rxd[3]}]  # IO_L18N_T2_A23_15 Sch=eth_rxd[3]
...
#set_property PACKAGE_PIN H14 [get_ports {eth_txd[0]}]  # IO_L15P_T2_DQS_15 Sch=eth_txd[0]
#set_property IOSTANDARD LVCMOS33 [get_ports {eth_txd[0]}]
#set_property PACKAGE_PIN J14 [get_ports {eth_txd[1]}]  # IO_L19P_T3_A22_15 Sch=eth_txd[1]
#set_property IOSTANDARD LVCMOS33 [get_ports {eth_txd[1]}]
#set_property PACKAGE_PIN J13 [get_ports {eth_txd[2]}]  # IO_L17N_T2_A25_15 Sch=eth_txd[2]
#set_property IOSTANDARD LVCMOS33 [get_ports {eth_txd[2]}]
#set_property PACKAGE_PIN H17 [get_ports {eth_txd[3]}]  # IO_L18P_T2_A24_15 Sch=eth_txd[3]
...
#set_property PACKAGE_PIN K17 [get_ports {qspi_dq[0]}]  # IO_L1P_T0_D00_MOSI_14 Sch=qspi_dq[0]
#set_property IOSTANDARD LVCMOS33 [get_ports {qspi_dq[0]}]
#set_property PACKAGE_PIN K18 [get_ports {qspi_dq[1]}]  # IO_L1N_T0_D01_DIN_14 Sch=qspi_dq[1]
#set_property IOSTANDARD LVCMOS33 [get_ports {qspi_dq[1]}]
#set_property PACKAGE_PIN L14 [get_ports {qspi_dq[2]}]  # IO_L2P_T0_D02_14 Sch=qspi_dq[2]
#set_property IOSTANDARD LVCMOS33 [get_ports {qspi_dq[2]}]
#set_property PACKAGE_PIN M14 [get_ports {qspi_dq[3]}]  # IO_L2N_T0_D03_14 Sch=qspi_dq[3]
